...
ALLOWED_HOSTS = ['https://cryptic-shelf-71509-4e312cd92d34.herokuapp.com/']
...
INSTALLED_APPS = [
    ...
    # Recipe Project Apps Inserted Starting Here
    'recipes',
]
...
# Link the media folder for uploading and displaying images
MEDIA_URL = '/media/'
